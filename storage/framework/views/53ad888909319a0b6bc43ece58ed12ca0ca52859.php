                ...
                <div class="profile">
                    <div class="d-flex w-100">
                        <div class="ava-wrapper"><!-- AVA -->
                            <div class="ava">
                                <img src="<?php echo e($user->profile->ava); ?>" alt="">
                            </div>
                        </div><!-- END AVA -->
                        <div class="w-25">
                            <div class="user">
        ...
        <div class="d-flex"><!-- content wrapper -->
            ...
            <aside class="profile-aside"><!-- aside right -->
                ...
                <section class="block"><!-- Groups -->
                    ...
                    <div class="block-content">
                        <div class="d-flex">
                            <?php $__currentLoopData = $user->group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="m-1">
                                    <a href="#">
                                        <img src="/img/sample-group.jpg" alt="">
                                        <span class="item-title"><?php echo e($group->name); ?></span>
                                    </a>
                                </div>
                ...
                <section class="block"><!-- Events -->
                    <div class="header">
                        <a href="#">
                            ...
                            <h3>friends</h3>
                            <span class="items-count"><?php echo e($user->friend()->count()); ?></span>
                        </a>
                    </div>
                    ...
                    <div class="block-content">
                        ...
                        <div class="friends">
                            ...
                            <?php $__currentLoopData = $user->friend; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $friend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <a href="<?php echo e(route('user-profile', $friend->username)); ?>" class="friend">
                                    <img src="/img/sample-friend.jpg" alt="body">
                                    <h2><?php echo e($friend->username); ?></h2>
                                </a>
